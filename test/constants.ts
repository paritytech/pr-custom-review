...
export const defaultTeamsNames = { "locks-review-team": team, "team-leads-team": team2, "action-review-team": team3 };
...
export const configFileContentsApiPath = `/repos/${org}/${repo}/contents/${encodeURIComponent(configFilePath)}`;
...
export const rulesExamples: {
  ...
  BasicRule: { name: condition, condition: condition, check_type: "diff", min_approvals: 1 },
  AndRule: { name: condition, condition: condition, check_type: "diff", all: [] },
  OrRule: { name: condition, condition: condition, check_type: "diff", any: [] },
  AndDistinctRule: { name: condition, condition: condition, check_type: "diff", all_distinct: [] },
};
